...
$page_title = "Hubungi Kami | WasiatKu";
$current_page = "hubungi";
?>
<!DOCTYPE html>
<html lang="ms">
<head>
  ...
  <style>
    /* Inline styles specifically for the contact grid */
    .contact-grid {
      display: grid;
...
<body class="page-hubungi">
  ...
  <section class="inner-page-hero fade-in">
    <div class="inner-page-hero-content">
      ...
      <span class="section-label light-label">Bantuan 24/7</span>
      <h1>Hubungi Kami</h1>
      <p class="hero-tagline">Kami sedia membantu merancang legasi anda</p>
    </div>
  </section>

  <!-- ================= CONTACT INFO ================= -->
  <section class="section fade-in" style="background: #fcfcfc; padding-bottom: 120px;">
    <div style="text-align: center; margin-bottom: 50px;">
      <h2 style="font-family: var(--font-h); color: var(--navy); font-size: 2.2rem; margin-bottom: 15px;">Maklumat Perhubungan</h2>
      <p style="color: var(--muted); max-width: 600px; margin: 0 auto;">Jika anda mempunyai sebarang soalan, pihak Khidmat Pelanggan kami sentiasa bersedia untuk memberi panduan kepada anda.</p>
    </div>
    ...
    <div class="contact-grid">
      ...
      <div class="contact-card">
        ...
        <h3>Talian Awam</h3>
        <p>Hubungi Khidmat Pelanggan kami secara terus.</p>
        <a href="tel:+60182209929" style="font-weight: bold; color: var(--teal-dark); display: inline-block; margin-top: 15px;">+60 18-220 9929</a>
      </div>

      <div class="contact-card">
        <div class="contact-icon">📧</div>
        <h3>E-mel Kepada Kami</h3>
        <p>Hantar pertanyaan anda dan kami akan balas secepat mungkin.</p>
        <a href="mailto:enquiry@wasiatku.com.my" style="font-weight: bold; color: var(--teal-dark); display: inline-block; margin-top: 15px;">enquiry@wasiatku.com.my</a>
      </div>

      <div class="contact-card">
        <div class="contact-icon">🏢</div>
        <h3>Pejabat Utama</h3>
        <p>Datang kunjungi kami untuk sesi perundingan.</p>
        <p style="font-size: 0.9rem; margin-top: 15px;">
          B-2-19, Blok Bougainvillea,<br>
