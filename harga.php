...
// Common header logic (simplified for local rendering without DB)
$page_title = "Harga & Pakej Kami | WasiatKu";
$current_page = "harga";
?>
<!DOCTYPE html>
<html lang="ms">
...
<body class="page-harga">
  ...
  <section class="inner-page-hero fade-in">
    <div class="inner-page-hero-content">
      ...
      <span class="section-label light-label">Pakej Wasiat</span>
      <h1>Harga &amp; Pakej Kami</h1>
      <p class="hero-tagline">Wasiat Anda. Masa Depan Mereka.</p>
    </div>
  </section>
    ...
    <div class="pricing-grid">
      ...
      <div class="pricing-card">
        <div class="pricing-header">
          <h3>Pelan Asas</h3>
          <div class="price"><span class="currency">RM</span> 280</div>
        </div>
        <div class="pricing-features">
          <ul>
            <li><span class="check">✓</span> <strong>10</strong> Aset dan Liabiliti Yang Disenaraikan</li>
            <li><span class="check">✓</span> Pelaksana Utama: <strong>1 Orang</strong></li>
            <li><span class="check">✓</span> Pelaksana Pengganti: <strong>2 Orang</strong></li>
            <li><span class="check">✓</span> Penerima Manfaat: <strong>Tiada Had</strong></li>
          </ul>
        </div>
        <div class="pricing-footer">
          <a href="#" class="btn-primary">Pilih Pelan Ini</a>
        </div>
      </div>

      <!-- Plan 2 -->
      <div class="pricing-card featured-plan">
        <div class="featured-badge">Paling Popular</div>
        <div class="pricing-header">
          <h3>Pelan Tambahan</h3>
          <div class="price"><span class="currency">RM</span> 480</div>
        </div>
        <div class="pricing-features">
          <ul>
            <li><span class="check">✓</span> <strong>Tanpa Had</strong> Aset dan Liabiliti</li>
            <li><span class="check">✓</span> Pelaksana Utama: <strong>1 Orang</strong></li>
            <li><span class="check">✓</span> Pelaksana Pengganti: <strong>2 Orang</strong></li>
            <li><span class="check">✓</span> Penerima Manfaat: <strong>Tiada Had</strong></li>
          </ul>
